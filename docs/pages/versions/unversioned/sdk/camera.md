...
- **options (_object_)** --
  ...
  - **videoFrameWidth (_number_)** -- Android only. The target video frame width in pixels. The target width should be supported by the device.
  - **videoFrameHeight (_number_)** -- Android only. The target video frame height in pixels. The target height should be supported by the device.
